...
public class TimeCommand implements SubCommand {
    ...
    public void onCommand(CommandSender sender, String[] args) {
        ...
        if (optionalNextTime.isPresent()) {
            ...
            component = MiniMessage.miniMessage().deserialize(configHandler.getBossTimeMessage(),
            ...
            component = MiniMessage.miniMessage().deserialize(configHandler.getNoBossTimeMessage());
        }
